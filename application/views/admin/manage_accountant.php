	...
	<div class="box-content padded"><div class="tab-content"><div class="tab-pane box active" id="edit" style="padding: 5px"><div class="box-content">
	  <div class="padded">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('edit_accountant');?></button>
			...
			<div class="" id="add" style="padding: 5px">

                <div class="box-content">

                    <?php echo form_open('admin/manage_accountant/create/' , array('class' => 'form-horizontal validatable'));?>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('add_accountant');?></button>
