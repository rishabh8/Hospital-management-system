	...
	<div class="box-content padded"><div class="tab-content"><div class="tab-pane box active" id="edit" style="padding: 5px"><div class="box-content">
	  <div class="padded">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('edit_pharmacist');?></button>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                	...
                	<thead>
                		...
                		<tr>
                    		...
                    		<th><div><?php echo get_phrase('pharmacist_name');?></div></th>
                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_pharmacist/create/' , array('class' => 'form-horizontal validatable'));?>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('add_pharmacist');?></button>
